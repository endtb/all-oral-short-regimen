...
call add_concept(@concept_id, @concept_name_short_id, @concept_name_full_id, 'Treatment cohort', ' cohort', 'Coded','Misc', FALSE);
...
insert into program_attribute_type(name, description, datatype, datatype_config, min_occurs, creator, date_created, uuid) values('Treatment cohort','Cohort', 'org.bahmni.module.bahmnicore.customdatatype.datatype.CodedConceptDatatype', @concept28_id, 0, 1, NOW(), UUID());
